                            ...
                            <table class="table table-borderless mt-1">
                                <tbody>
                                    <tr>
                                        ...
                                        <td><?= $detSliderr->foto_slider ?></td>
                                    </tr>
                                    <tr>
                                        <td class="text-right">Deskripsi Slider :</td>
                                        <td><?= $detSliderr->deskripsi_slider ?></td>
                                    </tr>
                                    <tr>
                                        <td class="text-right">Foto Slider :</td>
                                        <td><img src="<?= base_url() ?>assets/dist/img/slide2/<?= $detSliderr->file_slider ?>" alt="Foto Slider" class="img-fluid"></td>
                                    </tr>
                                </tbody>
                            </table>
                            <div class="form-group text-center">
                                <a class="btn btn-secondary px-3 mr-1" href="<?= base_url() ?>admin/slider_kedua">Kembali</a>
                            </div>
                        <?php } ?>
                    </div>
                </div>
