			...
			<div class="card-header">
				<ul class="nav nav-tabs card-header-tabs" id="custom-tabs-four-tab" role="tablist">
					<li class="nav-item" role="presentation">
						<?= anchor('comment/publik', 'Publik', ['class' => 'nav-link ' . ($current === 'publik' ? 'active' : '')]) ?>
					</li>
					<li class="nav-item" role="presentation">
						<?= anchor('comment/pending', 'Pending', ['class' => 'nav-link ' . ($current === 'pending' ? 'active' : '')]) ?>
					</li>
				</ul>
			</div>
			<div class="card-body">
								...
								<div class="list-group-item list-group-item-action">
									<div class="d-flex w-100">
										...
										<div class="w-100">
											...
											<small class="d-block border-bottom mb-2 pb-2"><?= indonesian_date($komen->tanggal_komentar) ?></small>
											...
											<div class="btn-toolbar" role="group">
												...
												<div class="btn-group mr-2" role="group">
													...
													<?php if ($komen->status === '1') { ?>
														<button type="button" class="btn btn-outline-dark" data-toggle="modal" data-target="#modalEdit<?= $komen->id_komentar ?>">
															<i class="fas fa-comment"></i> Balas</button>
													<?php } ?>
